...
public class TencentCOS {
    ...
    // 此处填写的存储桶名称
    private static final String bucketName = "image-1304681438";
    // secretId
    private static final String secretId = "AKIDIlIacMuhCQA1dzQHoiMWkiRznn7CCZ6N";
    // secretKey
    private static final String secretKey = "s3RChhrlQKXw5zS1LPXycnicZImzkrUy";
